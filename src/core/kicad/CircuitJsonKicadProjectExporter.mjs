...
export class CircuitJsonKicadProjectExporter {
     ...
     * @param {{ projectName?: string, libraryName?: string, basePath?: string, modelFiles?: object[], includeModelEntries?: boolean, modelPathPrefix?: string }} [options] Export options.
