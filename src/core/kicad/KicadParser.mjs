...
function normalizePad(pad, footprints) {
    ...
    return {
        ...
        shapeTopName: layers.top.shape,
        shapeMidName: layers.mid.shape,
        shapeBottomName: layers.bottom.shape,
        ...
        cornerRadiusMid: cornerRadiusPercent(layers.mid.roundrectRatio),
        cornerRadiusBottom: cornerRadiusPercent(layers.bottom.roundrectRatio),
