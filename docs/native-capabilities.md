...
This document covers `KicadToolkitCapabilities` and `KicadFeatureParity`, both
retained at `kicad-toolkit/extensions`.
...
```js
import { KicadToolkitCapabilities } from 'kicad-toolkit/extensions'
...
```js
import { KicadFeatureParity } from 'kicad-toolkit/extensions'
...
Renderer-side helper parity is provided through `kicad-toolkit/extensions`.
...
```js
import { KicadReadinessReport } from 'kicad-toolkit/extensions'
